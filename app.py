...
# 1. 웹 페이지 기본 레이아웃 및 툴바 숨김 CSS 설정
st.set_page_config(
...
# 3) [신규 추가] 달러 인덱스(DXY) & 미국 증시(S&P 500) 추이
